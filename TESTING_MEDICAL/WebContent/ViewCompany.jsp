...
<table style="border: 1px solid rgb(0, 0, 102);" align="center" bgcolor="#A8B7B6" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
	  ...
	  <fieldset>
					<legend><span class="style3">View Company</span></legend>
  <br />
    ...
    <table width="100%" border="0" align="center" bordercolor="#8692E3">
      ...
      <%
	     ...
	     try{
             ...
             aCoreHash = companydao.listCompany();
      ...
      <%
         ...
         if(header.equals("list"))
         {
		     flag = "true";
      %>
        <td bgcolor="#C3D7BA"><input name="ch" type="checkbox" id="checkbox2" onclick="check1()" value="<%=companyid%>"/></td> 
        <%} %>
        ...
        <td bgcolor="#C3D7BA"><div align="center" class="style7">
         <%
          ...
          {
         %>
        <a href="EditCompany.jsp?id=<%=companyid%>"><%=company.getCompanyName()%></a>
        <%} %>
        </div></td>
      ...
      <tr>
        <td colspan="4"><div align="center">
          ...
          <input type="button" name="button" id="button" value="Add New" onClick="javascript:location.href='DispatchController?page=AddNewCompany.jsp'"/>
          &nbsp;
          <%if(!aCoreHash.isEmpty())
          {%>
