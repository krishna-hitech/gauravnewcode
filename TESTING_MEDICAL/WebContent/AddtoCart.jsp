  ...
  <body>
     ...
     try
     {
       ...
       // aOrder.setBrandid(brandid);
        aSales.setCategoryid(categoryid);
        aSales.setMedicineid(medicineid);
        
        Integer key = new Integer(categoryid+""+medicineid);
       
        if(aCoreHash.put(key,aSales)==null)
        {
        		count++;
        		flag = true;
