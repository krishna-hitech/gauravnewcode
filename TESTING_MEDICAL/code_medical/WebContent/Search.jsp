...
<html>
  ...
  <tr>
    <td width="41" height="31"><label for="inputtext1">Company</label></td>
    <td width="120"><select name="companyid" id="select" >
  ...
  <tr>
    ...
    <td><select name="categoryid" id="select" onchange="javascript: location.href='LoginForm.jsp?categoryid='+document.search.categoryid.value+'&companyid='+document.search.companyid.value;">
      <option>--Select--</option>
      <%
		  		try
		  		{
  ...
  <tr>
    <td height="30"><label for="inputtext1">Medicine</label></td>
    <td><select name="medicineid" id="select" >
          <option>--Select--</option>
          <%
             if(request.getParameter("categoryid")!=null)
             {
